import {
  DECOR, FOODS, REPUTATION_UNLOCKS, SPECIES, SPECIES_ORDER, SYNERGIES, TANKS,
  UPGRADES, reputationFor, schoolCost,
  speciesCost, tankBar, tankPacing, upgradeCost,
} from "./content";
import { computeDerived, lvl, pelletBaseline, tankOutput } from "./economy";
import type {
  Derived, DecorId, FishSave, FoodId, GameState, SpeciesId, UpgradeId,
} from "./types";

// Pure economy math lives in ./economy; this file owns the state, the store
// plumbing and the purchase/progression actions on top of it.

export { computeDerived, fishValue, pelletBaseline, tankOutput } from "./economy";
