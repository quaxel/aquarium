...
const SPECIES_BLURBS: Record<Exclude<Language, "tr">, Record<SpeciesId, string>> = {
  en: {
    ...
    pufferfish: "Inflates as it eats. After 12 bites it POPS and scatters 2× its stored value.", crab: "Digs through the sand and collects everything below. Doubles digs beside a stingray.",
  ...
  de: {
    ...
    pufferfish: "Bläht sich beim Fressen auf. Nach 12 Bissen platzt er und verteilt den 2-fachen Wert.", crab: "Gräbt im Sand und sammelt alles am Boden. Mit einem Rochen gibt es doppelte Funde.",
  ...
  fr: {
    ...
    pufferfish: "Gonfle en mangeant. Après 12 bouchées, il éclate et disperse 2× sa réserve.", crab: "Fouille le sable et ramasse tout au fond. Les fouilles doublent près d'une raie.",
...
const FOOD_BLURBS: Record<Exclude<Language, "tr">, Record<FoodId, string>> = {
  en: { flake: "Free. Forever free. The fuel behind every combo.", shrimpPellet: "Value ×2.4, growth ×1.5. Your first real investment choice.", worm: "Splits in two underwater: two fish, two bites, two combo hits.", starFood: "Each bite advances combo by 4. The shortcut to frenzy.", explosive: "Launches 3 more food when eaten. The source of chain reactions.", rainbow: "12% chance to permanently turn the eater into a rare ×2.5 variant.", mutant: "The eater goes wild: ×5 speed and production for 8 seconds.", krill: "Every bite guarantees a gold coin. Simple and ruthless." },
  de: { flake: "Gratis. Für immer gratis. Der Treibstoff jeder Combo.", shrimpPellet: "Wert ×2,4, Wachstum ×1,5. Die erste echte Investition.", worm: "Teilt sich im Wasser: zwei Fische, zwei Bissen, zwei Combo-Treffer.", starFood: "Jeder Bissen erhöht die Combo um 4. Der kurze Weg zur Frenzy.", explosive: "Schleudert beim Fressen 3 weitere Futterstücke heraus. Startet Kettenreaktionen.", rainbow: "12% Chance auf eine dauerhafte seltene Variante mit ×2,5.", mutant: "Der Fisch dreht durch: 8 Sekunden lang ×5 Tempo und Produktion.", krill: "Jeder Bissen garantiert eine Goldmünze. Einfach und gnadenlos." },
  fr: { flake: "Gratuit. Pour toujours. Le carburant de chaque combo.", shrimpPellet: "Valeur ×2,4, croissance ×1,5. Votre premier vrai investissement.", worm: "Se divise sous l'eau : deux poissons, deux bouchées, deux combos.", starFood: "Chaque bouchée avance le combo de 4. Le raccourci vers la frénésie.", explosive: "Libère 3 aliments supplémentaires quand il est mangé. Lance les réactions en chaîne.", rainbow: "12% de chance de créer définitivement une variante rare ×2,5.", mutant: "Le poisson se déchaîne : vitesse et production ×5 pendant 8 secondes.", krill: "Chaque bouchée garantit une pièce d'or. Simple et impitoyable." },
};
